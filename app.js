        ...
        try {
            const response = await fetch('https://api.openai.com/v1/chat/completions', {
                ...
                headers: {
                    ...
                    'Authorization': `Bearer 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`
                },
                body: JSON.stringify({
                    model: "gpt-4o-mini",
                    messages: [{
